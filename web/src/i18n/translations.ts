...
export const translations = {
  en: {
    ...
    traderDashboard: {
      ...
      cycles: 'Cycles',
      runtimeMinutes: 'Runtime: {minutes} min',
      active: 'Active',
    },
    ...
    terminalDashboard: {
      ...
      aiLiveDesc:
        'It reads the whole market before acting. The first decision usually appears in the execution log within one or two minutes. You can stop it at any time from the config page.',
      model: 'Model',
      strategy: 'Strategy',
      leverage: 'Leverage',
      scan: 'Scan',
      ...
      equity: 'Equity',
      totalPnl: 'Total P/L · incl. unrealized',
      realizedPnl: 'Realized P/L · closed trades',
      profitFactor: 'Profit factor',
      maxDrawdown: 'Max drawdown',
      trades: 'Trades',
      win: 'Win',
      ...
      orchestrationTopologyDesc:
        'Net inflow → signal → decision → execution → position',
      flow: 'Flow',
      signal: 'Signal',
      decision: 'Decision',
      execute: 'Execute',
      hold: 'Hold',
      currentPositions: 'Current positions',
      currentPositionsDesc: 'Current positions · live',
      open: 'Open',
      symbol: 'Symbol',
      sideLeverage: 'Side · lev.',
      entry: 'Entry',
      size: 'Size',
      pnl: 'P/L',
      returnPct: 'Return %',
      ...
      recentTradesDesc: 'Recent closes · symbol / side / hold / P/L',
      side: 'Side',
      holdTime: 'Hold',
      closed: 'Closed',
      ...
      tradesWin: '{trades} trades · {win}% win',
      noSymbolHistory: 'No symbol history.',
      edgeProfile: 'Edge profile',
      edgeProfileDesc: 'Net by hold time and side · after fees',
      executionLog: 'Execution log',
      executionLogDesc: 'AI decisions and fills per cycle',
      ...
      price: 'Price',
      netFlowLegend:
        'Net inflow = {window} net buying · green/red = buy/sell split · trades = count · price = last traded price',
      live: 'Live',
      syncing: 'Syncing',
      down: 'Offline',
      ...
      connectingHyperliquid: 'Connecting to Hyperliquid…',
      cumulative: 'Cumulative $',
      spread: 'Spread',
      lastClosedSummary: 'Last {sample} closed · {takeaway}',
      edgeRow: '{trades} trades · {win}% win · fees ${fees}',
      market: 'Market',
      ...
      fault: 'Fault',
      flat: 'Flat',
      longLean: 'Long-leaning',
      shortLean: 'Short-leaning',
      balanced: 'Balanced',
      risky: 'Risky',
      high: 'High',
      safe: 'Safe',
      ...
      shortHoldEdge:
        'Short holds outperform in this sample ({short} vs {long} ≥ 1h)',
    },
  ...
  zh: {
    ...
    traderDashboard: {
      ...
      noStrategy: '未配置策略',
      cycles: '运行轮次',
      runtimeMinutes: '运行时长：{minutes} 分钟',
      active: '活跃',
    },

    terminalDashboard: {
      togglePresentation: '切换演示模式',
      orchestration: '智能体编排',
      running: '运行中',
      stopped: '已停止',
      cycle: '轮次',
      ...
      aiLive: '交易智能体已启动。',
      aiLiveDesc:
        '它会先分析整个市场再执行操作；首次决策通常会在一两分钟内显示在下方执行日志中。你可以随时在配置页停止它。',
      model: '模型',
      strategy: '策略',
      leverage: '杠杆',
      scan: '扫描间隔',
      ...
      sharpePerTrade: '单笔夏普',
      avgWinLoss: '平均盈亏',
      orchestrationTopology: '智能体编排拓扑',
      orchestrationTopologyDesc: '资金流 → 信号 → 决策 → 执行 → 持仓',
      flow: '资金流',
      signal: '信号',
      decision: '决策',
      execute: '执行',
      ...
      recentTrades: '最近交易',
      recentTradesDesc: '最近平仓 · 标的 / 方向 / 持有时长 / 盈亏',
      side: '方向',
      holdTime: '持有时长',
      closed: '平仓时间',
      ...
      tradesWin: '{trades} 笔 · 胜率 {win}%',
      noSymbolHistory: '暂无标的交易历史。',
      edgeProfile: '优势分布',
      edgeProfileDesc: '按持有时长和方向统计净收益（扣费后）',
      executionLog: '执行日志',
      executionLogDesc: '每轮 AI 决策与成交记录',
      ...
      bearish: '看空',
      neutral: '中性',
      clickToSwitch: '点击切换标的',
      signals: '个信号',
      netInflow: '净流入',
      buySell: '买入 / 卖出',
      price: '价格',
      netFlowLegend:
        '净流入 = {window} 净买入 · 绿/红 = 买卖占比 · 交易 = 笔数 · 价格 = 最新成交价',
      live: '实时',
      syncing: '同步中',
      down: '离线',
      ...
      connectingHyperliquid: '正在连接 Hyperliquid…',
      cumulative: '累计金额',
      spread: '价差',
      lastClosedSummary: '最近 {sample} 笔已平仓 · {takeaway}',
      edgeRow: '{trades} 笔 · 胜率 {win}% · 手续费 ${fees}',
      market: '市场',
      liveCandles: '实时 K 线',
      bars: '根 K 线',
      ...
      unrealizedPnl: '未实现盈亏',
      average: '平均',
      peakCap: '/ 峰值 {peak} · 上限 {cap}',
      ofEquity: '占账户权益',
      topPositionShare: '最大单仓占比',
      peakDrawdown: '峰值回撤',
      heldCap: '当前 / 上限',
      longHoldEdge: '优势集中在持有 ≥ 1 小时（{long}，1 小时内为 {short}）',
      shortHoldEdge: '当前样本中短时持有更优（{short}，≥ 1 小时为 {long}）',
    },
  ...
  id: {
    ...
    traderDashboard: {
      ...
      cycles: 'Siklus',
      runtimeMinutes: 'Waktu berjalan: {minutes} menit',
      active: 'Aktif',
    },

    terminalDashboard: {
      togglePresentation: 'Alihkan mode presentasi',
