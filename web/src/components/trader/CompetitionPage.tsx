              ...
              {sortedTraders.map((trader, index) => {
                ...
                return (
                  <div
                    ...
                    className={`rounded p-3 transition-all duration-300 hover:translate-y-[-1px] cursor-pointer hover:shadow-lg border ${
                      isLeader
                        ? 'bg-nofx-gold/10 border-nofx-gold/40 shadow-sm'
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className="font-bold text-sm flex items-center gap-1.5 text-nofx-text">
                      ...
                      <div className="flex items-center gap-2 md:gap-3 flex-wrap md:flex-nowrap">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs md:text-sm font-bold mono text-nofx-text">
                        ...
                        <div className="text-right min-w-[70px] md:min-w-[90px]">
                          ...
                          <div className="text-xs mono text-nofx-text-muted">
                            {(trader.total_pnl ?? 0) >= 0 ? '+' : ''}
            ...
            <div className="grid grid-cols-2 gap-4">
              {sortedTraders.map((trader, index) => {
                ...
                return (
                  <div
                    key={trader.trader_id}
                    className={`p-4 rounded transition-all duration-300 hover:scale-[1.02] border ${
                      isWinning
                        ? 'bg-nofx-success/10 border-nofx-success/30'
                        : 'bg-nofx-bg-lighter border-nofx-border'
                    }`}
                  >
