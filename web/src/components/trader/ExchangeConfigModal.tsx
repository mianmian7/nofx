...
function ExchangeCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`flex flex-col items-center gap-2 p-4 rounded-xl transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 border ${
        selected
    ...
    >
      ...
      <span className="text-xs px-2 py-0.5 rounded-full bg-nofx-gold/15 text-nofx-gold font-mono">
...
export function ExchangeConfigModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 overflow-y-auto backdrop-blur-sm">
      <div
        className="rounded-2xl w-full max-w-2xl relative my-8 shadow-2xl bg-nofx-bg-lighter border border-nofx-border"
          ...
          <div className="flex items-center gap-3">
            {currentStep > 0 && !editingExchangeId && (
              <button
                type="button"
                onClick={handleBack}
                className="p-2 rounded-lg hover:bg-nofx-bg-deeper transition-colors text-nofx-text-muted hover:text-nofx-text"
              >
          ...
          <div className="flex items-center gap-2">
            {currentExchangeType === 'binance' && currentStep === 1 && (
              <button
                ...
                className="px-3 py-2 rounded-lg text-sm font-semibold transition-all hover:scale-105 flex items-center gap-2 bg-nofx-gold/15 text-nofx-gold border border-nofx-gold/30"
              >
            ...
            {editingExchangeId && (
              <button
                ...
                className="p-2 rounded-lg hover:bg-nofx-danger/20 transition-colors text-nofx-danger"
              >
        ...
        >
          ...
          {(currentStep === 1 || editingExchangeId) && selectedTemplate && (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="p-4 rounded-xl flex items-center gap-4 bg-nofx-bg border border-nofx-border">
                {getExchangeIcon(selectedTemplate.exchange_type, {
                  width: 48,
                  height: 48,
                })}
                <div className="flex-1">
                  <div className="font-semibold text-lg text-nofx-text">
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg transition-all hover:scale-105 bg-nofx-gold/10 border border-nofx-gold/30"
                >
                  <UserPlus className="w-4 h-4 text-nofx-gold" />
                  <span className="text-sm font-medium text-nofx-gold">
                    {t('exchangeConfig.register', language)}
                  </span>
                  {exchangeRegistrationLinks[currentExchangeType || '']
                    ?.hasReferral && (
                    <span className="text-xs px-1.5 py-0.5 rounded bg-nofx-success/20 text-nofx-success">
              ...
              {/* Account Name */}
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-semibold text-nofx-text">
                  <Key className="w-4 h-4 text-nofx-gold" />
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl text-base bg-nofx-bg border border-nofx-border text-nofx-text focus:border-nofx-gold focus:outline-none"
                  required
                />
              </div>
