...
export default function DeploymentHub() {
  ...
  return (
    <section className="py-24 bg-nofx-bg relative overflow-hidden border-t border-nofx-border">
      {/* Background Grids */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-nofx-text-muted text-lg leading-relaxed font-light">
              One command on your laptop or any server installs everything. Open
              the address it prints, create your account, and the guided launch
              takes you to your first AI trade in about five minutes — around
              $13 is enough to start.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Docker handles every dependency',
                },
                {
                  icon: Shield,
                  label: 'Your Keys Stay Home',
                  desc: 'Runs on your machine, keys encrypted locally',
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-start p-4 rounded bg-nofx-bg-lighter border border-nofx-border hover:border-nofx-gold/30 transition-colors group"
                >
                  <div className="p-2 rounded bg-nofx-bg-deeper border border-nofx-border text-nofx-gold group-hover:bg-nofx-gold/10 transition-colors">
          ...
          >
            ...
            <div className="relative rounded-xl overflow-hidden bg-nofx-bg-lighter border border-nofx-border shadow-lg">
              {/* Terminal Header */}
              <div className="flex items-center justify-between px-4 py-3 bg-nofx-bg-deeper border-b border-nofx-border">
              ...
              <div className="p-8 font-mono text-sm md:text-base bg-nofx-bg-lighter min-h-[200px] flex flex-col justify-center">
                ...
                <div
                  className="group relative flex items-start gap-3 p-4 rounded-lg bg-nofx-bg-deeper border border-nofx-border hover:border-nofx-gold/50 cursor-pointer transition-all hover:bg-nofx-bg"
                  onClick={handleCopy}
                >
