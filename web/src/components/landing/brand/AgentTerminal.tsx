...
export default function AgentTerminal() {
  return (
    ...
    >
      {/* Terminal frame */}
      <div className="relative bg-nofx-bg-lighter rounded-2xl overflow-hidden shadow-lg border border-nofx-border">
        {/* Header bar - macOS style */}
        <div className="flex items-center justify-between px-4 py-2.5 bg-nofx-bg-deeper border-b border-nofx-border">
          {/* Window controls */}
        ...
        <div className="p-4 border-b border-nofx-border">
        ...
        {/* Metrics Row */}
        <div className="grid grid-cols-3 divide-x divide-nofx-border border-b border-nofx-border">
        ...
        {/* Footer status bar */}
        <div className="px-4 py-2 bg-nofx-bg-deeper border-t border-nofx-border flex items-center justify-between">
