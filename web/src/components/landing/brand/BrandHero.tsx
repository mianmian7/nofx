          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="border-2 border-nofx-border text-nofx-text text-lg font-bold px-8 py-4 uppercase tracking-wider hover:bg-nofx-text/5 hover:border-nofx-text transition-all flex items-center gap-2"
              >
