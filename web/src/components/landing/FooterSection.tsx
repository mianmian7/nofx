            ...
            <div className="flex flex-wrap gap-2">
              {links.supporters.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs border border-nofx-border bg-nofx-bg-lighter rounded px-3 py-1.5 transition-all hover:border-[#E0483B] hover:text-[#E0483B] hover:bg-[#E0483B]/10"
                  style={{ color: '#8A8478' }}
                >
                  {link.name}
                </a>
