  ...
  return (
    <DeepVoidBackground className="min-h-screen pb-12" disableAnimation>
      <div className="w-full px-4 md:px-8 relative z-10 pt-6">
        {/* Trader Header */}
        <div className="mb-6 rounded-lg p-6 animate-scale-in bg-nofx-bg-lighter border border-nofx-border group">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              {traders && traders.length > 0 && (
                <div className="flex items-center gap-2 bg-nofx-bg-lighter px-1 py-1 rounded-lg border border-nofx-border">
                  <NofxSelect
          ...
          <div className="flex items-center gap-6 text-sm flex-wrap text-nofx-text-muted font-mono pl-2">
            <span className="flex items-center gap-2">
              <span className="opacity-60">
                {t('traderDashboard.aiModel', language)}:
              </span>
              <span
            ...
            <span className="flex items-center gap-2">
              <span className="opacity-60">
                {t('traderDashboard.exchange', language)}:
              </span>
            ...
            {status && (
              <div className="hidden md:contents">
                ...
                <span>
                  {t('traderDashboard.cycles', language)}:{' '}
                ...
                <span className="w-px h-3 bg-nofx-text/10" />
                <span>
                  {t('traderDashboard.runtimeMinutes', language, {
        ...
        {status && <AIModelRuntimeStatus status={status} language={language} />}

        {/* Debug Info */}
        <div className="mb-4 px-3 py-1.5 rounded bg-nofx-bg-deeper border border-nofx-border text-[10px] font-mono text-nofx-text-muted flex justify-between items-center opacity-60 hover:opacity-100 transition-opacity">
          <span className="text-nofx-success">SYSTEM_STATUS::ONLINE</span>
          {account ? (
            <div className="flex gap-4">
            ...
            <span className="text-nofx-danger">
        ...
        {status?.strategy_type === 'grid_trading' && selectedTraderId && (
          ...
          >
            <GridRiskPanel traderId={selectedTraderId} />
          </div>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            >
              ...
              {positions && positions.length > 0 ? (
                <div>
                    ...
                    <table className="w-full text-xs">
                      ...
                      <tbody>
                        {paginatedPositions.map((pos, i) => (
                          <tr
                            key={i}
                            className="border-b border-nofx-border last:border-0 transition-all hover:bg-nofx-gold/10 cursor-pointer group/row"
                            onClick={() => {
                  ...
                  {/* Pagination footer */}
                  {totalPositions > 10 && (
                    <div className="flex flex-wrap items-center justify-between gap-3 pt-4 mt-4 text-xs border-t border-nofx-border text-nofx-text-muted">
                      <span>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                          ...
                          <NofxSelect
                            ...
                            className="bg-nofx-bg-deeper border border-nofx-border rounded px-2 py-1 text-xs text-nofx-text-main transition-colors"
                          />
                        </div>
          ...
          >
            {/* Header */}
            <div className="flex items-center gap-3 mb-5 pb-4 border-b border-nofx-border shrink-0">
              <div
              ...
              <NofxSelect
                ...
                className="px-3 py-1.5 rounded-lg text-sm font-medium cursor-pointer transition-all bg-nofx-bg-deeper text-nofx-text-main border border-nofx-border hover:border-nofx-accent"
              />
            </div>
...
function StatCard({
  ...
  return (
    <div className="group nofx-glass p-5 rounded-lg transition-all duration-300 hover:bg-nofx-gold/5 hover:translate-y-[-2px] border border-nofx-border hover:border-nofx-gold/40 relative overflow-hidden">
